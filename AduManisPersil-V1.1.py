...
ShapefileDir = "E:\DataDummyAduManis1.shp"
...
V = np.mat(MatriksA) * np.mat(X) - np.mat(MatriksF)
#print("Matriks Residu = ", V)
Var = np.transpose(V) * np.mat(V) / (numObs - numParams)
print("Variansi A-posteriori = ", Var)

Qxx = np.linalg.inv(MatriksAtA);
#Sxx = Var[0] * Qxx;
...
ShapefileOut = "D:\Eksperimen\AduManis\Data Dummy Pengukuran Persil Tanah\Data Dummy Pengukuran Persil Tanah Cleaned7.shp"
